...
def schedule(self, Session, SchoolId, PersonType, PersonId):
	"""
	SCHEDULE_STUDENT_URL = "https://www.lectio.dk/lectio/{}/SkemaNy.aspx?type=elev&elevid={}".format(SchoolId, PersonId)
	SCHEDULE_TEACHER_URL = "https://www.lectio.dk/lectio/{}/SkemaNy.aspx?type=laerer&laererid={}".format(SchoolId, PersonId)
	"""

	#Formats the url for person type
	if (PersonType == "Student"):
		SCHEDULE_URL = "https://www.lectio.dk/lectio/{}/SkemaNy.aspx?type=elev&elevid={}".format(SchoolId, PersonId)
	elif (PersonType == "Teacher"):
		SCHEDULE_URL = "https://www.lectio.dk/lectio/{}/SkemaNy.aspx?type=laerer&laererid={}".format(SchoolId, PersonId)
	else:
		exit()
		return "Error"
